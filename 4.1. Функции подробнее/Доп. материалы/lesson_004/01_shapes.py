...
draw_for_the_people(point=point_0, corner=25, number_of_corners=8, len_side=82, color=sd.COLOR_RED)
...
draw_for_the_people(point=point_3, corner=25, number_of_corners=7, len_side=90, color=sd.COLOR_RED)
