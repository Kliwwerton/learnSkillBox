...
# То есть каждый символ имеет свой код. В пайтоне символы хранятся в кодах unicode
...
# как символы будут сохраняться на жестком диске или передаваться по сети.
